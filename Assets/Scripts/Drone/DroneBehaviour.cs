...
//Explication: Cette classe a pour but de créer la trajectoire du drone pour suivre le joueur dans le bâtiment sans
//entrer en collision avec des obstacles
...
public class DroneBehaviour : MonoBehaviour
{
    ...
    void MakePath(Transform target)
    {
        ...
        for (int i = 0; i < nbrPoints; i++)
        {
            ...
            while (splineSizeDecrement < largeurSplineMax)
            {
                ...
                // Pour mieux visualiser les splines, utilisez le DrawRay ci-dessous
    ...
    {
        if (Vector3.Distance(followTarget.transform.position, lastPLayerPoint) > maximumDistance)
